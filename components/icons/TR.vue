<template>
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 110.000000 49.000000"
        fill="currentColor" preserveAspectRatio="xMidYMid meet">
        <g transform="translate(0.000000,49.000000) scale(0.100000,-0.100000)" stroke="none">
            <path d="M73 465 c-13 -9 -23 -27 -23 -41 0 -13 -10 -45 -21 -69 -19 -40 -20
        ...
        28 34 162 59 187 35 7 -7 20 -11 29 -7z"></path>
            <path d="M133 350 c-7 -11 -9 -21 -3 -25 5 -3 11 -1 14 3 3 5 17 7 31 4 26 -5
        59 14 49 29 -11 18 -79 10 -91 -11z"></path>
        </g>
    </svg>
</template>