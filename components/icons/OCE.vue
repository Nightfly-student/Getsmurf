<template>
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 87.000000 87.000000"
        fill="white" preserveAspectRatio="xMidYMid meet">
        <g transform="translate(0.000000,87.000000) scale(0.100000,-0.100000)" stroke="none">
            <path d="M411 847 c-8 -11 -24 -12 -72 -4 -57 9 -64 9 -78 -10 -9 -11 -28 -23
    ...
    -11 19 -18z"></path>
            <path d="M740 435 c-6 -15 -7 -37 -4 -50 6 -23 -15 -48 -116 -138 -25 -21 -31
    ...
    18 8 30 36 48 20 13 43 31 51 40 16 20 31 21 31 2z"></path>
            <path d="M550 115 c-10 -12 -10 -21 -2 -38 5 -12 13 -30 16 -40 8 -25 35 -32
    54 -14 16 17 16 20 -18 87 -10 21 -35 24 -50 5z"></path>
        </g>
    </svg>
</template>