            ...
            <div class="relative bg-zinc-800 modalWidth mx-5 md:mx-0 rounded-lg shadow">
                ...
                <div class="px-6 pb-3 space-y-6">
                    ...
                    <div class="flex gap-10 items-center justify-center">
                        <button @click="yesOrNo(true)"
                            class="p-4 px-6 text-xl bg-light-50 dark:bg-dark-50 text-white rounded-20">Yes</button>
                        <button @click="yesOrNo(false)"
                            class="border p-4 px-6 text-xl  rounded-20 border-1 border-gray-700">No</button>
                    </div>
                </div>
            </div>
        </div>
...
const emits = defineEmits(["modalEvent", "selected"]);
const clickOutside = () => {
    emits("modalEvent", false);
};
const yesOrNo = (selection: Boolean) => {
    emits("modalEvent", false);
